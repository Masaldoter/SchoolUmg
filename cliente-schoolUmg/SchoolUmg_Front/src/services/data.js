...
// ===============================
// ALUMNOS (ajusta si tu backend usa otras rutas)
// ===============================
...
/** POST insertar calificación (porcentaje requerido al crear) */
export function insertCalificacion(calificacion) {
  const body = {
    descripcion: calificacion.descripcion,
    nota: Number(calificacion.nota),
    porcentaje: Number(calificacion.porcentaje), // requerido al crear
...
/** PUT actualizar calificación (NO enviamos porcentaje si no lo editamos) */
export function actualizarCalificacion(calificacion) {
  ...
  const body = {
    descripcion: calificacion.descripcion,
    nota: Number(calificacion.nota),
    porcentaje: Number(calificacion.porcentaje),   // <— ahora lo mandamos
    matriculaId: Number(calificacion.matriculaId),
  };
